...
public class InventoryService {
	public void sprint1Details() throws Exception {
		...
		MultipartFile multipartFile = new MockMultipartFile("Order_Summary.xlsx", new FileInputStream(new File("H:\\SL\\msbatch3-sprint1\\src\\main\\resources\\Order_Summary.xlsx")));
		...
		System.out.println( "#####  Scenario 1 : Stock Summary Per Day #####");
		...
		System.out.println( "#####   Scenario 2 : Sales Leader Board: Top 5 items in demand #####  ");
		...
		System.out.println( "#####   Scenario 3 : Summary of total items sold today  #####   ");
		...
		System.out.println( "#####   Scenario 4 : Summary of total items sold per month #####  ");
		...
		System.out.println( "#####   Scenario 5 : Summary of Quantity of sale for one particular item #####  ");
		...
		System.out.println("End: Scenario 5");
	}
}
